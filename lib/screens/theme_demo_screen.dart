...
import 'package:practice_mobile_app/utils/global_theme.dart';
import 'package:practice_mobile_app/utils/strings.dart';
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Row(
                children: const [Text('Логин: '), Expanded(child: TextField())],
              ),
              Row(
                children: const [
                  Text('Пароль: '),
